    ...
    <div class="form-border">
        ...
        <div class="form-items">
            <form action="signup.php" method="POST" class="login-form" autocomplete="off">
                        ...
                        <?php
                            if(isset($errorMsg[0])){
                                foreach($errorMsg[0] as $firstNameErrors){
                                    echo("<errdiv style='font-family:source-serif-pro,serif;color:#f01e2c;font-size:12px;'>".$firstNameErrors."</errdiv>");
                                }
                            }
                        ...
                        <?php
                            if(isset($errorMsg[2])){
                                foreach($errorMsg[2] as $lastNameErrors){
                                    echo("<errdiv style='font-family:source-serif-pro,serif;color:#f01e2c;font-size:12px;'>".$lastNameErrors."</errdiv>");
                                }
                            }
                ...
                <dd class="form-labels"><input type="email" name="emailAddress" class="box-size-long" value="<?php echo $emailAddress;?>" placeholder="Email"></dd>
                <?php
                    if(isset($errorMsg[3])){
                        foreach($errorMsg[3] as $emailErrors){
                            echo("<errdiv style='font-family:source-serif-pro,serif;color:#f01e2c;font-size:12px;'>".$emailErrors."</errdiv>");
                        }
                    }

    ...
    <div class="form-border">    
        ...
        <div class="form-items">
            <form action="login.php" method="POST" class="login-form" autocomplete="off">
                ...
                <br>
                <dd class="form-labels"><input type="password" class="box-size-long" name="pass" placeholder="Password"></dd>
                <?php
                    if(isset($errorMsg[1])){
        ...
        <br>
        <p class="no-account">Don't have an account? <a href="signup.php" class="registerhere">Register Here</a></p>
        <p class="or">or</p>
